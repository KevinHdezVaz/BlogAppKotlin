...
import com.kevin.courseApp.databinding.FragmentCuatroBinding
...
class FragmentCuatro : Fragment() {
    ...
    override fun onCreateView(
        ...
        val fadeInAnimation = AnimationUtils.loadAnimation(requireContext(), R.anim.advanced_init_3)
        tvTitle.startAnimation(fadeInAnimation)

        val animacion2 = AnimationUtils.loadAnimation(requireContext(), R.anim.from_right_0)
        tvDescription.startAnimation(animacion2)
