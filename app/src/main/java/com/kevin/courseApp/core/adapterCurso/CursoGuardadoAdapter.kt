...
import com.kevin.courseApp.databinding.ItemCursoguardadoBinding
import com.squareup.picasso.Picasso
class CursoGuardadoAdapter(var cursos: List<Cursos>) : RecyclerView.Adapter<CursoGuardadoAdapter.CursoViewHolder>() {
 ...
 override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CursoViewHolder {
        val binding = ItemCursoguardadoBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class CursoViewHolder(private val binding: ItemCursoguardadoBinding) : RecyclerView.ViewHolder(binding.root) {
